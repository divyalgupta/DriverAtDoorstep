...
<div style="width:120%;height:230px;background-color:rgba(0,0,0,0.8);margin-left:400px;border:10px;margin-top:-400px;">
    <br>
...
<form action="deleteoperatorCode.jsp">
    <table style="background: rgba(0,0,0,0.7);margin-left: 970px;padding-right:-70px;
           padding-bottom: 30px;border-radius: 15px;width: 550px;margin-top:-260px;">
        ...
        <tr>
            <td style="font-size: 20px;padding-left:25px;color:white;">Enter Operator ID to Delete Operator</td>
            <tr align="center"><td style="padding-top:20px;"><input type = "text" name = "uId" placeholder = "Enter operator id to delete operator" 
