...
<form action="deletedriverCode.jsp">
    <table style="background: rgba(0,0,0,0.7);margin-left: 970px;padding-right:-70px;
        ...
        <tr>
            <td style="font-size: 20px;padding-left:25px;color:white;">Enter Driver ID to Delete Driver</td>
            <tr align="center"><td style="padding-top:20px;"><input type = "text" name = "DriverId" placeholder = "Enter driver id to delete driver" 
