...
<form action = "usercomplaintCode.jsp">
    <table style="background: rgba(0,0,0,0.4);margin-left: 450px;padding-left:10px;padding-right:-70px;
        ...
        <tr><td style="padding-top:30px;padding-left:10px;">
            </td></tr>
        <tr>
            <td style="font-size: 20px;padding-left:25px;color:white;">User ID</td>
            <td><input type = "text" name = "userID" placeholder = "Enter your id here" 
                       style="width: 325px;height: 35px;border-radius:10px;margin-left:-90px;padding-left:10px;"></td>
        </tr>      
        <tr>
            <td style="font-size: 20px;height:100px;padding-left:25px;color:white;margin-top: 10px;">Complaint</td>
        </tr>
        <tr>
            <td><textarea type = "text" name = "complaint" placeholder = "Write your Complaint here" 
                       style="width: 325px;height: 100px;border-radius:10px; margin-left:30px;"></textarea></td>
        </tr>
        <tr>
            <td style="font-size: 20px;padding-left:25px;color:white;">Complaint Date</td>
            <td><input type = "date" name = "compDate" placeholder = "Enter date" 
                       style="width: 325px;height: 35px;border-radius:10px;margin-left:-90px;padding-left:10px;"></td>
        </tr>  
