...
<td><img src="user.png" style="width:45px;height:45px;font-size:50px;margin-left:115px;margin-top:-120px;"></td>
 ...
 <div>
    <table style="background:rgba(0,0,0,0.5);margin-top:-410px;border-radius:15px;margin-left: 500px;height:80px;
           width:80px;padding-right:50px;padding-left:50px;padding-bottom:40px;padding-top:40px;">
       <tr  bgcolor="white" align="center">
       <td class="tdtheme" style="margin-top:20px;padding-left:30px;padding-right:30px;">
           <a href="drivercrud.jsp">DRIVER</a></td>           
          
      <td class="tdtheme" style="margin-left:50px;padding-left:30px;padding-right:30px;"><a href="operatorcrud.jsp">
                OPERATOR</a></td>
