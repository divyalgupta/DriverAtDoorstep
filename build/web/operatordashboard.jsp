...
<td><img src="user.png" style="width:45px;height:45px;font-size:50px;margin-left:115px;margin-top:-120px;"></td>
 ...
 <div>
    <table style="background:rgba(0,0,0,0.4);margin-top:-350px;margin-left: 550px;height:100px;width:100px;
           padding-left:-20px;padding-top:150px;">
       <tr  bgcolor="white" align="center">
                <td class="tdtheme"><a href="adddriver.jsp">ADD DRIVER</a></td>
            
            
                <td class="tdtheme"><a href="">DELETE DRIVER</a></td>
       </tr>
          <tr  bgcolor="white" align="center">
                 <td class="tdtheme"><a href="">UPDATE DRIVER</a></td>
           
            
                 <td class="tdtheme"><a href="">SEARCH DRIVER</a></td>
