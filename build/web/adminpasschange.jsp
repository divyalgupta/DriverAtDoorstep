...
<td><img src="user.png" style="width:45px;height:45px;font-size:50px;margin-left:115px;margin-top:-120px;"></td>
  <td>  <h2 style="width: 120px;height: 40px;border-radius:8px;margin-left:110px;margin-top:-120px;color:white;
    ...
    <table style="background: rgba(87,50,44,0.6);
        ...
        <tr align="center">
            <td><a href="adminetting.jsp" style="font-size: 22px;color:white;">Settings</a>
            </td>
        </tr>
        ...
        <tr align="center">
            <td style="height:30px;"><hr></td>
                ...
                <tr align="center">
                    <td><a href="Notification.jsp" style="font-size: 22px;color:white;">Query Detail</a>
            </td>
        </tr>
        <tr align="center">
            <td style="height:30px;"><hr></td>
                ...
                <tr align="center">
                    <td><a href="invoice.jsp" style="font-size: 22px;color:white;">Invoice Detail</a>
            </td>
        </tr>     
    </table>  
            </div>
