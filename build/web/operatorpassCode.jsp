...
<%
    ...
    PreparedStatement st = con.prepareStatement("select * from operator where operID=? and password=?");
	st.setString(1,id);
       ...
       if(rs.next())
       {
           ...
           {
               PreparedStatement st1 = con.prepareStatement("update operator set password=? where operID=?");
