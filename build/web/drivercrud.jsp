...
<td><img src="user.png" style="width:45px;height:45px;font-size:50px;margin-left:115px;margin-top:-120px;"></td>
 ...
 <div>
    <table style="background:rgba(0,0,0,0.5);margin-top:-430px;border-radius:15px;margin-left: 500px;height:80px;
           width:80px;padding-right:50px;padding-left:50px;padding-bottom:60px;padding-top:60px;">
       <tr  bgcolor="white" align="center">
                <td class="tdtheme" style="padding-left:30px;padding-right:30px;"><a href="adddriver.jsp">ADD DRIVER</a></td>
            
            
                <td class="tdtheme" style="padding-left:30px;padding-right:30px;"><a href="deletedriver.jsp">DELETE DRIVER</a></td>
       </tr>
          <tr  bgcolor="white" align="center">
                 <td class="tdtheme" style="padding-left:30px;padding-right:30px;"><a href="updatedriver.jsp">UPDATE DRIVER</a></td>
           
            
                 <td class="tdtheme" style="padding-left:30px;padding-right:30px;"><a href="">SEARCH DRIVER</a></td>
