 ...
 <div>
    <table style="background:rgba(0,0,0,0.5);margin-top:-430px;border-radius:15px;margin-left: 500px;height:80px;
       ...
       <tr  bgcolor="white" align="center">
                <td class="tdtheme" style="padding-left:30px;padding-right:30px;"><a href="addoperator.jsp">ADD OPERATOR</a></td>
            
            
                <td class="tdtheme" style="padding-left:30px;padding-right:30px;"><a href="deleteoperator.jsp">DELETE OPERATOR</a></td>
       </tr>
          <tr  bgcolor="white" align="center">
                 <td class="tdtheme" style="padding-left:30px;padding-right:30px;"><a href="">UPDATE OPERATOR</a></td>
           
            
                 <td class="tdtheme" style="padding-left:30px;padding-right:30px;"><a href="">SEARCH OPERATOR</a></td>
