...
<td><img src="user.png" style="width:45px;height:45px;font-size:50px;margin-left:115px;margin-top:-120px;"></td>
 ...
 <form action = "userqueryCode.jsp">
    <table style="background: rgba(0,0,0,0.4);margin-left: 450px;padding-left:10px;padding-right:-70px;
        ...
        <tr>
            <td style="font-size: 20px;height:100px;padding-left:25px;color:white;margin-top: 10px">Write your Query here</td>
        </tr>
        <tr>
            <td><textarea type = "text" name = "query" placeholder = "Query"
                       style="width: 450px;height: 100px;border-radius:10px; margin-left:60px;padding-top:-10px;"></textarea></td>
        </tr>
