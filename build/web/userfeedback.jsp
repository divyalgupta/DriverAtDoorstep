...
<form action = "userfeedbackCode.jsp">
    <table style="background: rgba(0,0,0,0.4);margin-left: 450px;padding-left:10px;padding-right:-70px;
        ...
        <tr>
            <td style="font-size: 20px;height:100px;padding-left:25px;color:white;margin-top: 10px">Feedback</td>
        </tr>
        <tr>
            <td><textarea type = "text" name = "feedback" placeholder = "Enter feedback" 
