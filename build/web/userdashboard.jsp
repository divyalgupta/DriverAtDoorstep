...
<td><img src="user.png" style="width:45px;height:45px;font-size:50px;margin-left:115px;margin-top:-120px;"></td>
  <td>  <h2 style="width: 120px;height: 40px;border-radius:8px;margin-left:110px;margin-top:-120px;color:white;
        ...
        background:rgba(0,0,0,0.6);">Hi User</h2></td></div>
    ...
    <table style="background: rgba(87,50,44,0.6);
        ...
        <tr align="center">
         ...
         <tr align="center">
            <td><h3 style="width: 220px;height: 35px;border-radius:15px; color:white;">User name</h3></td>
        </tr>
        <tr align="center">
            <td style="height:10px;"><hr></td>
        </tr>
        <tr align="center">
            <td><a href="userdashboard.jsp" style="font-size: 22px;color:white;">Dashboard</a></td>
        </tr>
        <tr align="center">
        ...
        <tr align="center">
            <td><a href="userpasschange.jsp" style="font-size: 22px;color:white;">Settings</a>
            </td>
        </tr>
        ...
        <tr align="center">
            <td style="height:30px;"><hr></td>
                ...
                <tr align="center">
                    <td><a href="userquery.jsp" style="font-size: 22px;color:white;">Query Detail</a>
            </td>
        </tr>
        <tr align="center">
            <td style="height:30px;"><hr></td>
                ...
                <tr align="center">
                    <td><a href="userinvoice.jsp" style="font-size: 22px;color:white;">Invoice Detail</a>
            </td>
        </tr> 
        <tr align="center">
            <td style="height:30px;"><hr></td>
                ...
                <tr align="center">
                    <td><a href="usercomplaint.jsp" style="font-size: 22px;color:white;">Complaint</a>
            </td>
        </tr>
            ...
            <td style="height:30px;"><hr></td>
                ...
                <tr align="center">
                    <td><a href="userfeedback.jsp" style="font-size: 22px;color:white;">Feedback</a>
            </td>
        </tr>
    </table>  
            </div>

<form action = "userdashboardCode.jsp">
    <table style="background: rgba(0,0,0,0.4);margin-left: 450px;padding-left:10px;padding-right:-70px;
           padding-bottom: 30px;border-radius: 15px;width: 600px;margin-top:-550px;">
        <tr><td style="padding-top:30px;">
            </td>
        <td style="padding-top:40px;padding-left:10px;color:white">
                <h2>
                    HIRE DRIVER
                </h2>
            </td>
        ...
        <tr>
            <td style="font-size: 20px;padding-left:25px;color:white;">Source</td>
            <td><input type = "text" name = "source" placeholder = "Enter source here" 
                       style="width: 325px;height: 35px;border-radius:10px; margin-left:-90px;padding-left:10px;"></td>
        </tr>
        <tr>
            <td style="font-size: 20px;padding-left:25px;color:white;">Destination</td>
            <td>
                <input type = "text" name = "dest" placeholder = "Enter destination here" 
                       style="width: 325px;height:35px;border-radius:10px; margin-left:-90px;padding-left:10px;">
            </td>
        </tr>
        <tr>
            <td style="font-size: 20px;padding-left:25px;color:white">From Date</td>
            <td>
        ...
        <tr>
            <td style="font-size: 20px;padding-left:25px;color:white">Till Date </td>
            <td>
                <input type = "date" name = "tillDate" 
                       style="width: 325px;height: 35px;border-radius:10px;margin-left:-90px;padding-left:10px;">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type = "text" name = "contactNo" placeholder = "Enter contact details here" 
                       style="width: 325px;height:35px;border-radius:10px; margin-left:-90px;padding-left:10px;">
            </td>
        </tr>
        <tr>
            <td style="font-size: 20px;padding-left:25px;color:white;">Vehicle No.</td>
            <td>
