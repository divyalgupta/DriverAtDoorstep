...
<td><img src="user.png" style="width:45px;height:45px;font-size:50px;margin-left:115px;margin-top:-120px;"></td>
  <td>  <h2 style="width: 120px;height: 40px;border-radius:8px;margin-left:110px;margin-top:-120px;color:white;
    ...
    <table style="background: rgba(87,50,44,0.6);
        ...
        <tr align="center">
            <td><a href="operatorview" style="font-size: 22px;color:white;">View</a>
            </td>
        </tr>
...
<div>
    <table style="background: rgba(87,50,44,0.6);color:white;
           margin-left: 450px;padding-bottom: 15px;border-radius: 5px;width: 300px;margin-top:-350px;padding-top:35px;">
       <tr bgcolor="white" align="center" >
                <td class="tdtheme"><a href="viewdriver.jsp">VIEW DRIVER</a></td>
            
                <td class="tdtheme"><a href="viewoperator.jsp">VIEW USER</a></td>
       </tr>
       <tr  bgcolor="white" align="center">
                <td class="tdtheme"><a href="viewuser.jsp">VIEW HIRING</a></td>
            
                <td class="tdtheme"><a href="viewhiring.jsp">VIEW FEEDBACK</a></td>
       </tr>
       <tr  bgcolor="white" align="center">
                <td class="tdtheme"><a href="viewfeedback.jsp">VIEW COMPLAINT</a></td>
