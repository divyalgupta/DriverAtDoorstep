...
<td><img src="user.png" style="width:45px;height:45px;font-size:50px;margin-left:115px;margin-top:-120px;"></td>
  <td>  <h2 style="width: 120px;height: 40px;border-radius:8px;margin-left:110px;margin-top:-120px;color:white;
    ...
    <table style="color:white;
           margin-left: 400px;padding-bottom: 15px;border-radius: 5px;width: 300px;margin-top:-510px;padding-top:35px;">
...
<div style="width:180%;height:350px;background-color:rgba(0,0,0,0.8);margin-left:400px;border:10px;margin-top:-400px;">
    <br>
